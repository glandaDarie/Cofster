...
def create_coffee_drink(drink_information : Dict[str, str], callback_cup_detection : Callable[[bool], bool]):
    while True:
    ...
    while True:
        with consumer.data_lock:
            if len(consumer.drinks_information) > 0:
                ...
                background_create_coffee_drink_thread : Thread = Thread(target=create_coffee_drink, args=(consumer.drinks_information, callback_cup_detection))
