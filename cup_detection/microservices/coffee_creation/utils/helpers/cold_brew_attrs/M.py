...
from utils.helpers.cold_brew_attrs.ingredients_quantity import ingredients_quantity
...
# coffee process
def ground_coffee(pin : int) -> None:
    GPIO.output(pin, GPIO.LOW)
    sleep(ingredients_quantity.get("ground_coffee", 0)*M) 
    GPIO.output(pin, GPIO.HIGH)
