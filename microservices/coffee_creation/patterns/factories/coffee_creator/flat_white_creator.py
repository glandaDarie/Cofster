...
from utils.paths.flat_white_attrs_path import FLAT_WHITE_ATTRS_PATH
...
class FlatWhiteCreator(CoffeeCreator):
    ...
    @initialize_drink(*drinks_pin_mapper[CoffeeTypes.FLAT_WHITE.value], type_input=GPIO.OUT)
    def do(self, cortado_data : Dict[str, Any], *, pins : List[int] | None = None) -> Tuple[str]:
        params : Dict[str, Any] = {
            ...
            "attrs_path" : FLAT_WHITE_ATTRS_PATH
        }
